...
public class Project
{
    ...
    [JsonConstructor]  
    public Project(string ownerUsername, bool? isInvoicable, DateOnly? startDate, DateOnly? deadline, ProjectStatus? projectStatus, string? tagName, Priority? projectPriority)
    {
